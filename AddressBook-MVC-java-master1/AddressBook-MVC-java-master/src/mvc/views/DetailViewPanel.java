...
public class DetailViewPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txt_name.setForeground(new java.awt.Color(153, 0, 153));
        txt_name.setName("txt_name"); // NOI18N

        txt_mobileno.setForeground(new java.awt.Color(153, 0, 153));
        txt_mobileno.setName("txt_mobileno"); // NOI18N

        txt_email.setForeground(new java.awt.Color(153, 0, 153));
        txt_email.setName("txt_email"); // NOI18N

        jLabel4.setForeground(new java.awt.Color(0, 0, 204));
        jLabel4.setText("Address");

        txt_address.setForeground(new java.awt.Color(153, 0, 153));
